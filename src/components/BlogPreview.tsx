        ...
        <section className="py-32 w-full">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 text-lg leading-[1.7]">Practical breakdowns on AI workflows, automation, and systems for operators.</p>
                </div>
                <Link
                    href="/blog"
                ...
                {posts.length === 0 ? (
                    ...
                    posts.map((post) => (
                        <Link
                            key={post.slug}
                            href={`/blog/${post.slug}`}
                            className="group block p-8 rounded-3xl border border-transparent hover:border-gray-200 hover:bg-white hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-500 ease-out"
                        >
                            <article>
