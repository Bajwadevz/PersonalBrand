...
const tools = [
    {
        ...
        description: "Estimate hours and cost savings from automation in minutes.",
    ...
    },
    {
        ...
        description: "Measure readiness and get your next automation priority.",
    ...
    },
    {
        ...
        description: "Get a practical stack recommendation based on your goals.",
    ...
    },
    {
        ...
        description: "Discover deployable workflow ideas for your current tool stack.",
    ...
    },
    {
        ...
        description: "Access tested system prompts organized by role and workflow.",
    ...
    },
    {
        ...
        description: "Use proven cold email openers by role and use case.",
    ...
    },
    {
        ...
        description: "Generate quick enrichment scripts for CRM-ready lead data.",
    ...
    },
    {
        ...
        description: "Design clean inbound lead routing and scoring logic fast.",
    ...
    },
    {
        ...
        description: "Use focused discovery questions mapped to persona and stage.",
...
export default function ToolsPage() {
    return (
        <div className="section-shell relative w-full overflow-hidden">
            <section className="container-shell mb-12 max-w-4xl">
                <h1 className="text-[clamp(2.25rem,5vw,4rem)] font-bold tracking-tight">Free Tools</h1>
                <p className="mt-4 text-lg muted-copy">Practical calculators for operators. No account needed.</p>
            </section>
                    ...
                    {tools.map((tool) => {
                        ...
                        return (
                            <CardWrapper
                                key={tool.href}
                                href={tool.href}
                                className={`group glass-card card-hover rounded-2xl p-8 flex flex-col ${
                                    isLive 
                                        ? "cursor-pointer" 
                            ...
                            >
                                <div className="flex items-start justify-between mb-6">
                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center border ${
                                        isLive ? "bg-[rgba(45,106,143,0.12)] text-[#2D6A8F] border-[rgba(45,106,143,0.3)]" : "bg-gray-50 text-gray-400 border-gray-100"
                                    }`}>
                                    ...
                                    <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold border ${
                                        isLive ? "bg-[rgba(45,106,143,0.1)] text-[#2D6A8F] border-[rgba(45,106,143,0.3)]" : "bg-gray-50 text-gray-500 border-gray-200"
                                    }`}>
                                ...
                                <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium border self-start mb-4 ${
                                    isLive ? "bg-[rgba(45,106,143,0.08)] text-[#2D6A8F] border-[rgba(45,106,143,0.25)]" : "bg-gray-50 text-gray-400 border-gray-100"
                                }`}>
                                    {tool.category}
                                </span>

                                <h2 className={`text-xl font-bold mb-3 transition-colors leading-snug ${
                                    isLive ? "text-[var(--color-site-text)] group-hover:text-[#2D6A8F]" : "text-gray-500"
                                }`}>
                                    {tool.title}
                                </h2>
                                <p className={`text-sm leading-relaxed flex-grow ${
                                    isLive ? "muted-copy" : "text-gray-400"
                                }`}>
                                    {tool.description}
                                </p>
                                ...
                                <div className={`mt-6 pt-6 border-t flex items-center text-sm font-semibold transition-colors ${
                                    isLive 
                                        ? "border-[var(--color-site-border)] text-[#2D6A8F]" 
